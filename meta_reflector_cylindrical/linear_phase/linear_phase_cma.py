...
# Wavelength range (µm)
# =========================================================
lambdas = np.linspace(1.4, 1.6, 25)
...
# =========================================================
def loss_function(params, alpha=10.0, beta=100.0):
    ...
    loss = -np.abs(A) + alpha*rms + beta*curvature
...
# CMA INITIALIZATION
# =========================================================
x0_phys = np.array([0.233, 0.120, 0.300, 0.600])
