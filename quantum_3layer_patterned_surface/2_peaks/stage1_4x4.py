...
BASE_DIR = r"D:\msc\Research\presentations\week14\Run8"
...
SAVE_DIR = r"D:\msc\Research\presentations\week14\Run8"
...
def save_elite_geometries(elite_solutions, tag="run8"):
    """
...
# ---------- SAVE RESULTS ----------
save_elite_geometries(elite_solutions, tag="Run8")
...
def build_solver(lam, pattern, L_eff, hs_dbr, a):
    ...
    ep_pattern = ep = get_epgrid_4x4(pattern, eps_si, a).flatten()
